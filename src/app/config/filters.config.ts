...
export const FilterConfig = {
    products: {
        ...
        filters: (container, sp) => [
            ...
            {type: 'ng-select', label: 'Cliente', key: 'customerId',
                getMethod: (term) => container.customersService.getCustomersByName(term),
                items:  sp.filters_data.customers, labelVal: 'name', value: ''},
            {type: 'ng-select', label: 'Agenzia', getMethod: (term) => container.agenciesService.getAgenciesByName(term),
                key: 'agencyId', items: sp.filters_data.agencies, labelVal: 'name', value: ''},
            ...
            {type: 'ng-select', label: 'CAP Destinatario:', key: 'recipientCap', items: sp.filters_data.caps_group,
                labelVal: 'name', getMethod: (term) => container.recipientsService.getCapCity(term)},
