...
export class ChangeSubActivityStatusModalComponent extends ModalComponent implements OnInit, OnDestroy {
    ...
    loadStats() {
          ...
          {title: this.translate.instant('pages.dispatch_view.modals.set_status.wrong_massege'), value:'doing'},
          {title: this.translate.instant('pages.dispatch_view.modals.set_status.wrong_massege'), value:'done'}
        ];  
  }
    confirm() {
        this.confirmed = true ;
