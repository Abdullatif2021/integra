...
export class ChangeSubActivityStatusModalComponent extends ModalComponent implements OnInit, OnDestroy {
    ...
    loadStats() {
          ...
          this.stats = [
          {title: this.translate.instant('filter_config.subactivity.filter.modals.select_value.todo'), value:'todo'},
          {title: this.translate.instant('filter_config.subactivity.filter.modals.select_value.doing'), value:'doing'},
          {title: this.translate.instant('filter_config.subactivity.filter.modals.select_value.done'), value:'done'}
        ];  
  }
    confirm() {
        this.confirmed = true ;
