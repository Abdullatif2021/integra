...
import {ActivityDeleteComponent} from '../../../../../activities/modals/../modals/activity-delete/activity-delete.component';
...
export class PreDispatchProductsComponent implements OnInit, AfterViewChecked {
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            ...
            this.actionsService.setActions([   { name: this.translate.instant('home.activities_action.remove.value'), modal: ActivityDeleteComponent }]);
