...
export const TablesConfig = {
    ...
    simpleTable: {
        ...
        activity: {
            title: 'table_config.simpletable.activity_table.value',
            // icon: 'assets/images/postman-icon.png',
            searchPlaceHolder: 'table_config.simpletable.activity_table.plhold',
            text: 'activityName'
        },
        customPostmenTable: {
            custom: true,
            ...
            cols: [
                {title: 'table_config.table.pre_dispatch_table.cols.action', field: false, actions: [
                    ...
                    {action: 'view', click: (elm, container) => {
                        container.integraaModalService.open('/pages/pre-dispatch/' + elm.id + '/products', {width: 125, height: 650});
                    }},
